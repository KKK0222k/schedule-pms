...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/schedule/panel/insert.js"></script>
        ...
        <form id="insertForm" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div style="display:flex; gap:10px;">
                    ...
                    <button type="button" class="btn btn-primary" id="btnSearchAdres">주소 검색</button>
